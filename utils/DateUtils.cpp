 ...
 * Including STRPTIME for windows machines and a new format for comparisons using string
 *
 *  Created on: Jul 9, 2014
 *      Author: Vítor E. Silva Souza (vitorsouza@gmail.com)
 *
 *  Modified on: Nov 30, 2020
 *      by: André Altoé Santiago
 */
...
// Substituição do STRPTIME devido à utilização do windows
